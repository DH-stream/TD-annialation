...
- [ ] **Step 1: Add the simulation contracts without Babylon imports**
...
- [ ] **Step 2: Compose the scene with deliberate geometry and materials**
...
- [ ] **Step 3: Add camera interaction and engine lifecycle**
...
- [ ] **Step 4: Add the canvas shell and HUD-ready page styling**
...
- [ ] **Step 3: Verify camera interaction**
...
- [ ] **Step 6: Run final diff checks and commit the handoff**
